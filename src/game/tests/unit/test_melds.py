...
class TestCanCallOpenKan:
    ...
    def test_can_call_open_kan_with_three_matching_tiles(self):
        ...
        result = can_call_open_kan(player, discarded_tile=3, wall_count=10)
    ...
    def test_cannot_call_open_kan_with_two_matching_tiles(self):
        ...
        result = can_call_open_kan(player, discarded_tile=2, wall_count=10)
    ...
    def test_cannot_call_open_kan_when_wall_too_small(self):
        ...
        result = can_call_open_kan(player, discarded_tile=3, wall_count=1)
    ...
    def test_cannot_call_open_kan_wall_empty(self):
        ...
        result = can_call_open_kan(player, discarded_tile=3, wall_count=0)
...
class TestCanCallClosedKan:
    ...
    def test_can_call_closed_kan_with_four_tiles(self):
        ...
        result = can_call_closed_kan(player, tile_34=0, wall_count=10)
    ...
    def test_cannot_call_closed_kan_wall_too_small(self):
        ...
        result = can_call_closed_kan(player, tile_34=0, wall_count=1)
    ...
    def test_closed_kan_in_riichi_typically_not_allowed(self):
        ...
        # this tests a typical case where kan would change the hand structure
        #
    ...
    def test_closed_kan_in_riichi_tile_is_wait(self):
        ...
        result = can_call_closed_kan(player, tile_34=8, wall_count=10)
...
class TestCanCallAddedKan:
    ...
    def test_can_call_added_kan_with_pon_and_fourth_tile(self):
        ...
        result = can_call_added_kan(player, tile_34=0, wall_count=10)
    ...
    def test_cannot_call_added_kan_wall_too_small(self):
        ...
        result = can_call_added_kan(player, tile_34=0, wall_count=1)
...
class TestCallOpenKan:
    ...
    def test_call_open_kan_adds_dora_indicator(self):
        round_state = self._create_round_state_with_dead_wall()
    ...
    def test_call_open_kan_draws_from_dead_wall(self):
        round_state = self._create_round_state_with_dead_wall()
        initial_dead_wall_size = len(round_state.dead_wall)

        call_open_kan(round_state, caller_seat=0, discarder_seat=1, tile_id=3)

        assert len(round_state.dead_wall) == initial_dead_wall_size - 1
...
class TestCallClosedKan:
    ...
    def test_call_closed_kan_adds_dora_indicator(self):
        round_state = self._create_round_state_with_dead_wall()
        initial_dora_count = len(round_state.dora_indicators)
    ...
    def test_call_closed_kan_draws_from_dead_wall(self):
        round_state = self._create_round_state_with_dead_wall()
        initial_dead_wall_size = len(round_state.dead_wall)
...
class TestCallAddedKan:
    ...
    def test_call_added_kan_adds_dora_indicator(self):
        round_state = self._create_round_state_with_pon()
        initial_dora_count = len(round_state.dora_indicators)
    ...
    def test_call_added_kan_draws_from_dead_wall(self):
        round_state = self._create_round_state_with_pon()
        initial_dead_wall_size = len(round_state.dead_wall)
...
class TestGetPossibleClosedKans:
    ...
    def test_no_possible_kans(self):
        ...
        result = get_possible_closed_kans(player, wall_count=10)
    ...
    def test_no_kans_when_wall_too_small(self):
        ...
        result = get_possible_closed_kans(player, wall_count=1)
...
class TestGetPossibleAddedKans:
    ...
    def test_no_possible_added_kans(self):
        ...
        result = get_possible_added_kans(player, wall_count=10)
    ...
    def test_no_added_kans_when_wall_too_small(self):
        ...
        result = get_possible_added_kans(player, wall_count=1)
