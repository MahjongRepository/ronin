...
- `LOBBY_CONFIG_PATH` - Override default servers.yaml file path (default: `src/config/servers.yaml`)
- `LOBBY_LOG_DIR` - Log file directory (default: `logs/lobby`)
- `LOBBY_CORS_ORIGINS` - Allowed CORS origins as JSON array or CSV string (default: `["http://localhost:3000"]`)
